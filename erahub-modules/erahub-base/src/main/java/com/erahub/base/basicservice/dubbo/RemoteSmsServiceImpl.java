...
import com.erahub.common.sms.config.properties.SmsProperties;
import com.erahub.common.sms.core.SmsTemplate;
import com.erahub.common.sms.entity.SmsResult;
import com.erahub.base.basicservice.api.RemoteSmsService;
...
public class RemoteSmsServiceImpl implements RemoteSmsService {
     ...
     * @param param      模板对应参数
     */
    public BSSms send(String phones, String templateId, Map<String, String> param) throws ServiceException {
        if (!smsProperties.getEnabled()) {
            throw new ServiceException("当前系统没有开启短信功能！");
        }
        SmsTemplate smsTemplate = SpringUtils.getBean(SmsTemplate.class);
        SmsResult smsResult = smsTemplate.send(phones, templateId, param);
        return BeanUtil.toBean(smsResult, BSSms.class);
    }
