...
function getList() {
  loading.value = true
  listDemo(proxy.addDateRange(queryParams.value, daterangeCreateTime.value, 'CreateTime')).then(
    (response) => {
...
function getPage() {
  loading.value = true
  pageDemo(proxy.addDateRange(queryParams.value, daterangeCreateTime.value, 'CreateTime')).then(
    (response) => {
      demoList.value = response.rows
      total.value = response.total
      loading.value = false
