            ...
            <table cellspacing="0" style="width: 100%">
              ...
              <tbody>
                <tr>
                  ...
                  >
                  <td class="el-table__cell is-leaf"
                    ><div class="cell" v-if="server.swap">{{ server.swap.total }}G</div></td
                  >
                  <td class="el-table__cell is-leaf"
                ...
                <tr>
                  ...
                  >
                  <td class="el-table__cell is-leaf"
                    ><div class="cell" v-if="server.swap">{{ server.swap.used }}G</div></td
                  >
                  <td class="el-table__cell is-leaf"
                ...
                <tr>
                  ...
                  >
                  <td class="el-table__cell is-leaf"
                    ><div class="cell" v-if="server.swap">{{ server.swap.free }}G</div></td
                  >
                  <td class="el-table__cell is-leaf"
