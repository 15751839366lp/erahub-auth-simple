<template>
  <div class="app-container">
    <!-- 操作工具栏 -->
    <div class="mb-10px">
      <el-button v-hasPermi="['tool:database:doc:export']" type="primary" @click="handleExportHtml">
        <Iconify icon="ep:download" class="mr-5px" /> {{ '导出' + ' HTML' }}
      </el-button>
      <el-button v-hasPermi="['tool:database:doc:export']" type="primary" @click="handleExportWord">
        <Iconify icon="ep:download" class="mr-5px" /> {{ '导出' + ' Word' }}
      </el-button>
      <el-button
        v-hasPermi="['tool:database:doc:export']"
        type="primary"
...
import * as DbDocApi from '@/api/tool/dbDoc'
